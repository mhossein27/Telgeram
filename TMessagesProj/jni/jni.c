...
JNIEXPORT void Java_ir_telechat_radyab_messenger_Utilities_aesIgeEncryption(JNIEnv *env, jclass class, jobject buffer, jbyteArray key, jbyteArray iv, jboolean encrypt, int offset, int length) {
...
JNIEXPORT jstring Java_ir_telechat_radyab_messenger_Utilities_readlink(JNIEnv *env, jclass class, jstring path) {
