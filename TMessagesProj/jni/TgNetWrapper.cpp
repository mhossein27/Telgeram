...
static const char *FileLoadOperationClassPathName = "ir/telechat/radyab/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "ir/telechat/radyab/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "ir/telechat/radyab/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILir/telechat/radyab/tgnet/RequestDelegateInternal;Lir/telechat/radyab/tgnet/QuickAckDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("ir/telechat/radyab/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/telechat/radyab/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/telechat/radyab/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("ir/telechat/radyab/tgnet/ConnectionsManager"));
